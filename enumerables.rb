...
def print_spicy_foods(spicy_foods)
  ...
  spicy_foods.map do |spicy_food|
    spicy_food_array = '🌶' * spicy_food[:heat_level]
    print "#{spicy_food[:name]} (#{spicy_food[:cuisine]}) | Heat Level: " + spicy_food_array + "\n"
  end
...
def average_heat_level(spicy_foods)
  # your code here
  spicy_food_array = spicy_foods.map {|spicy_food| spicy_food[:heat_level]}
  spicy_food_array.sum / spicy_food_array.length
end
